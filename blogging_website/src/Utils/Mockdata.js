const blogs = [
  {
    ...
    previewDescription:
      "Closures are a powerful concept in JavaScript that allow",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    category: "Health",
    content:
      "Gut health plays a critical role in overall well-being, affecting everything from digestion to mood and immunity. A balanced gut microbiome helps absorb nutrients and defend against pathogens. Eating a diverse diet rich in fiber, fermented foods, and prebiotics supports good bacteria. Avoiding excessive antibiotics, managing stress, and getting enough sleep are also vital. Symptoms like bloating, fatigue, and irregular bowel movements can indicate gut issues. Regular physical activity further supports digestion and microbial balance. Maintaining gut health is a long-term investment in your vitality. A healthy gut can even influence mental clarity and reduce the risk of chronic diseases.",
    previewDescription:
